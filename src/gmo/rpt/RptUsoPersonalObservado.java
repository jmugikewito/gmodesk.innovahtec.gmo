...
/**
 ...
 @author Asus
 */
public class RptUsoPersonalObservado extends javax.swing.JInternalFrame {
    ...
    public RptUsoPersonalObservado(Window w) {
        this.Frame = w;
        initComponents();
        setSize(860, 560);
    ...
    private void gettin_data() {
        ...
        load = new SmartLoader((java.awt.Frame) Frame, true,
                "Descargando Datos",
                "Actualizando los Trabajadores Observados que fueron usado en Tareo...", (Window frame) -> {
                    tabla.initHttp("",
                            "fecha, tareo, subtareo, dni, nombres",
                            "fecha, tareo, subtareo, dni, nombres",
                            "DateSQLx1,Stringx4",
                            RunMain.gettin_pages.GetQuery() + "EXEC GetRptUsoPersonalObservado '" + jkeys.IDEMPRESA + "','" + chooserFecha1.toStringDate() + "', '" + chooserFecha2.toStringDate() + "';");
                    tabla.GetDatosHTTP();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Reporte de Personal Observado en Tareo");
